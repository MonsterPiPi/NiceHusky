package io.github.isliqian.interceptor;

/**
 * Created by LiQian_Nice on 2018/3/17
 */

import io.github.isliqian.config.RedisConfig;
...
public class MethodCacheInterceptor implements MethodInterceptor {
        ...
        try {
            ...
            if (value != null) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        redisConfig.set(tkey, tvalue, Long.parseLong(defaultCacheExpireTime));
                    }
                }).start();
            }
        } catch (Exception e) {
    ...
    public void setRedisUtil(RedisConfig redisConfig) {
